        ...
        <section class="abovefooter text-white" style="background-color:
            #CF111A;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="dichvu d-flex align-items-center">
                            ...
                            <div class="noidung">
                                <h3 class="tieude font-weight-bold">HƠN 14.000
                                    TỰA SÁCH HAY</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="dichvu d-flex align-items-center">
                            ...
                            <div class="noidung">
                                <h3 class="tieude font-weight-bold">MIỄN PHÍ
                                    GIAO HÀNG</h3>
                                <p class="detail">Từ 150.000đ ở Đà Nẵng</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="dichvu d-flex align-items-center">
                            ...
                            <div class="noidung">
                                <h3 class="tieude font-weight-bold">QUÀ TẶNG
                                    MIỄN PHÍ</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="dichvu d-flex align-items-center">
                            ...
                            <div class="noidung">
                                <h3 class="tieude font-weight-bold">ĐỔI TRẢ
                                    NHANH CHÓNG</h3>
                                <p class="detail">Hàng bị lỗi được đổi trả nhanh
                                    chóng</p>
                            </div>
                        </div>
                    </div>
        ...
        <footer>
            <div class="container py-4">
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="gioithieu">
                            <h3 class="header text-uppercase font-weight-bold">Về
                                BookStore</h3>
                            <a href="#">Giới thiệu về BookStore</a>
                            <a href="#">Tuyển dụng</a>
                            <div class="fb-like"
                                data-href="https://www.facebook.com/DealBook-110745443947730/"
                                data-width="300px" data-layout="button"
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="hotrokh">
                            <h3 class="header text-uppercase font-weight-bold">HỖ
                                TRỢ KHÁCH HÀNG</h3>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="lienket">
                            <h3 class="header text-uppercase font-weight-bold">HỢP
                                TÁC VÀ LIÊN KẾT</h3>
                            <img src="{{ asset('public/frontend/images/dang-ky-bo-cong-thuong.png')}}"
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="ptthanhtoan">
                            <h3 class="header text-uppercase font-weight-bold">Phương
                                thức thanh toán</h3>
                            <img src="{{ asset('public/frontend/images/visa-payment.jpg')}}"
                                alt="visa-payment">
                            <img src="{{ asset('public/frontend/images/master-card-payment.jpg')}}"
                            ...
                            <img src="{{ asset('public/frontend/images/payoo-payment.jpg')}}"
                                alt="payoo-payment">
        ...
        <div class="fixed-bottom">
            <div class="btn btn-warning float-right rounded-circle nutcuonlen"
                id="backtotop" href="#"
                style="background:#CF111A;"><i class="fa fa-chevron-up
                    text-white"></i></div>
        </div>
